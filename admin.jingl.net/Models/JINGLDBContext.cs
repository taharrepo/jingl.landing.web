...
namespace admin.jingl.net.Models
{
    public partial class JINGLDBContext : DbContext
    {
        ...
        public virtual DbSet<AdminAuth> AdminAuth { get; set; }
        public virtual DbSet<AdminRemarks> AdminRemarks { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=dbsophieparis.cmztxkrk8l6n.ap-southeast-1.rds.amazonaws.com;Initial Catalog=JINGLDB;Persist Security Info=True;User ID=jingluser;Password=jingluser_p4ss;MultipleActiveResultSets=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdminAuth>(entity =>
            {
            ...
            modelBuilder.Entity<AdminRemarks>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.CreatedDate).HasColumnType("datetime");

                entity.Property(e => e.CreatedEmail).HasMaxLength(150);

                entity.Property(e => e.UpdatedDate).HasColumnType("datetime");

                entity.Property(e => e.UpdatedEmail).HasMaxLength(150);
            ...
            modelBuilder.Entity<LandingRegistration>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
